...
begin
	process(forwardA, ALUresult, WBresult, ID_EX_ReadData1)
	begin
		opAmuxOut <= ID_EX_ReadData1 when forwardA = "00" else WBresult when forwardA = "01" else ALUresult when forwardA = "10";
	end process;
end Behavioral;